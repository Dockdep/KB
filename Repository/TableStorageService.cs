...
{
  public class TableStorageService<T> : StorageServiceBase where T : ITableEntity, new()
  {
    ...
    public TableStorageService() : this(typeof(T).Name + "Table")
    {
    }

    public TableStorageService(string tableName) : base()
    {
      TableName = tableName;
      InitilizeInternal();
    }
